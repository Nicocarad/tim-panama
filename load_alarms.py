...
if __name__ == "__main__":
    ...
    mob_alarms_df = pd.read_parquet(
        "alarms datasets/mob/20230101-20240101_inpas_mob_preprocess__an__last_event__last_event__ext1.parquet"
    )

    tx_alarms_adsl_df = pd.read_parquet(
        "alarms datasets/tx/20230101-20240101_inpas_tx_preprocess__adsl__last_event__last_event__ext1.parquet"
    )
    tx_alarms_pdh_df = pd.read_parquet(
        "alarms datasets/tx/20230101-20240101_inpas_tx_preprocess__pdh__last_event__last_event__ext1.parquet"
    )
    tx_alarms_ptn_df = pd.read_parquet(
        "alarms datasets/tx/20230101-20240101_inpas_tx_preprocess__ptn__last_event__last_event__ext1.parquet"
    )
    ...
    print("Loading lavori programmati...")

    lavori_programmati_df = pd.read_csv(
        "lavori programmati/20230101_20240101_export_cac_all_preprocessed.csv"
    )
    ...
    new_tx_alarms_pdh_df = associate_alarm_id_to_lp_id(
        filtered_tx_alarms_pdh_df, lavori_programmati_df
    )
    new_tx_alarms_ptn_df = associate_alarm_id_to_lp_id(
        filtered_tx_alarms_ptn_df, lavori_programmati_df
    )
    ...
    new_tx_alarms_pdh_df.to_parquet(
        "alarms datasets/tx/[new]20230101-20240101_inpas_tx_preprocess__pdh__last_event__last_event__ext1_with_lp_id.parquet"
    )
    new_tx_alarms_ptn_df.to_parquet(
        "alarms datasets/tx/[new]20230101-20240101_inpas_tx_preprocess__ptn__last_event__last_event__ext1_with_lp_id.parquet"
    )
